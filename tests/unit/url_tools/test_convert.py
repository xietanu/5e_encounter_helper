...
def test_query_string_to_kwargs_empty():
    ...
    kwargs = convert_query.query_string_to_kwargs("?")
...
def test_kwargs_to_query_string():
    ...
    query_string = convert_query.kwargs_to_query_string(**{})
...
def test_kwargs_to_query_string_single():
    ...
    query_string = convert_query.kwargs_to_query_string(**{"key": "value"})
...
def test_kwargs_to_query_string_arg_with_spaces():
    ...
    query_string = convert_query.kwargs_to_query_string(**{"key": "value with spaces"})
